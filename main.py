...
def start_module() -> str:
    """
    Call this function first if you want to interact with LabVIEW. It will start the labview server that you can use to do actions in LabVIEW. You can use "Stop Module" to stop the server again. Make sure to call thsi function before any other LabVIEW specific functions.The Functions Inputs are: 
    """
    lv_app  = get_labview()
...
def new_vi() -> str:
    """
    Creates a new VI in the LabVIEW IDE. The VI Reference is stored and returned. This Reference can later be used to e.g. add modifications to the VI.The Functions Inputs are: 
    """
    lv_app  = get_labview()
    vi_name = r"new_vi.vi"
    current_dir = os.path.dirname(__file__)
...
The Functions Inputs are: parameter name: "object_id" - parameter description: ""
...
The Functions Inputs are: parameter name: "vi_reference" - parameter description: ""
...
When creating a control or constant you can pass a value to be written to that element.The Functions Inputs are: parameter name: "constant" - parameter description: ""
parameter name: "terminal_index" - parameter description: ""
parameter name: "object_id" - parameter description: ""
...
The Functions Inputs are: parameter name: "open_frontpanel" - parameter description: ""
...
def save_vi(path: str,vi_id: int) -> str:
    """
    Saves a VI to the specified path. If Path is empty and vi was saved before, it saves to same location. Include the file name in the path.The Functions Inputs are: parameter name: "path" - parameter description: ""
parameter name: "vi_id" - parameter description: ""
...
_____
Created using DQMH Framework: Event Scripter 7.1.0.1503.The Functions Inputs are: parameter name: "value" - parameter description: ""
parameter name: "object_id" - parameter description: ""
...
_____
Created using DQMH Framework: Event Scripter 7.1.0.1503.The Functions Inputs are: parameter name: "subvi_path" - parameter description: ""
parameter name: "diagram_id" - parameter description: ""
...
The Functions Inputs are: parameter name: "index" - parameter description: ""
parameter name: "structure_id" - parameter description: ""
...
def stop_module() -> str:
    """
    Call this tool to stop the labview server. You must use "start module" to start it again to do actions in LabVIEW. Stopping the server will delete all temporary data, so after restarting it you cannot access the objects anymore.The Functions Inputs are: 
    """
    lv_app  = get_labview()
