...
def start_module() -> str:
    ...
    """
    lv_app  = get_labview()
    vi_path = r"G:\My Drive\Coding\custom-mcp-server\labview_assistant\LabVIEW_Server\Scripting Server\Start Module.vi"
...
parameter name: "object_id" - parameter description: ""
    ...
    """
    lv_app  = get_labview()
    vi_path = r"G:\My Drive\Coding\custom-mcp-server\labview_assistant\LabVIEW_Server\Scripting Server\create_control.vi"
    vi      = lv_app.GetVIReference(vi_path, "", False, 0)
...
parameter name: "vi_id" - parameter description: ""
    ...
    """
    lv_app  = get_labview()
    vi_path = r"G:\My Drive\Coding\custom-mcp-server\labview_assistant\LabVIEW_Server\Scripting Server\run_vi.vi"
    vi      = lv_app.GetVIReference(vi_path, "", False, 0)
...
def stop_module() -> str:
    ...
    """
    lv_app  = get_labview()
    vi_path = r"G:\My Drive\Coding\custom-mcp-server\labview_assistant\LabVIEW_Server\Scripting Server\Stop Module.vi"
    vi      = lv_app.GetVIReference(vi_path, "", False, 0)
